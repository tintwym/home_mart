...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Google Play Store listing URL (native Android app)
    |--------------------------------------------------------------------------
    |
    | When set, the /download page shows a primary link to the Play Store.
    | The Android client is native (Kotlin), not a WebView wrapper.
    |
    */

    'android_play_store_url' => env('APP_ANDROID_PLAY_STORE_URL', ''),
